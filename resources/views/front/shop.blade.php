                    ...
                    <div class="product-card">
                        <div class="product-grid-content">
                            <div class="product-header">
                                ...
                                <h3><a href="{{route('client.product-detail')}}">Here Is A Quick Cure For Book</a></h3>
                            </div>
                        ...
                        <div class="product-list-content">
                            ...
                            <div class="product-card--body">
                                <div class="product-header">
                                    ...
                                    <h3><a href="{{route('client.product-detail')}}" tabindex="0">Qpple cPad with Retina Display
                                            MD510LL/A</a></h3>
                                </div>
                                <article>
                        ...
                        <div class="product-list-content">
                            ...
                            <div class="product-card--body">
                                <div class="product-header">
                                    ...
                                    <h3><a href="{{route('client.product-detail')}}" tabindex="0">Apple iPad with Retina Display
                                            MD510LL/A</a></h3>
                                </div>
                                <article>
                                    <h2 class="sr-only">Card List Article</h2>
                    ...
                    <div class="product-card">
                        <div class="product-grid-content">
                            <div class="product-header">
                                ...
                                <h3><a href="{{route('client.product-detail')}}">How Deal With Very Bad BOOK</a></h3>
                            </div>
                            <div class="product-card--body">
                                <div class="card-image">
                    ...
                    <div class="product-card">
                        <div class="product-grid-content">
                            <div class="product-header">
                                ...
                                <h3><a href="{{route('client.product-detail')}}">The Hidden Mystery Behind</a></h3>
                            </div>
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="{{asset('assets/front/image/products/product-10.jpg')}}" alt="">
                    ...
                    <div class="product-card">
                        <div class="product-grid-content">
                            <div class="product-header">
                                ...
                                <h3><a href="{{route('client.product-detail')}}">Little Known Ways To Rid Yourself</a></h3>
                            </div>
                            <div class="product-card--body">
                                <div class="card-image">
                    ...
                    <div class="product-card">
                        <div class="product-grid-content">
                            <div class="product-header">
                                ...
                                <h3><a href="{{route('client.product-detail')}}">Qple GPad with Retina Sisplay</a></h3>
                            </div>
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="{{asset('assets/front/image/products/product-2.jpg')}}" alt="">
