...
<main class="inner-page-sec-padding-bottom">
  ...
  <div class="brand">
    <img src="{{asset('assets/front/image/others/review-tab-product-details.jpg')}}" alt="">
  </div>
                ...
                <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            ...
                            <h3>
                            <a href="{{route('client.product-detail')}}">Revolutionize Your BOOK With</a>
                            </h3>
                        </div>
                ...
                <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            ...
                            <h3>
                                <a href="{{route('client.product-detail')}}">Turn Your BOOK Into High Machine</a>
                            </h3>
                        </div>
                        <div class="product-card--body">
                            <div class="card-image">
                ...
                <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            ...
                            <h3>
                                <a href="{{route('client.product-detail')}}">3 Ways Create Better BOOK With</a>
                            </h3>
                        </div>
                        <div class="product-card--body">
                            <div class="card-image">
                ...
                <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            ...
                            <h3>
                                <a href="{{route('client.product-detail')}}">What You Can Learn From Bill Gates</a>
                            </h3>
                        </div>
                        <div class="product-card--body">
                            <div class="card-image">
                ...
                <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            ...
                            <h3>
                                <a href="{{route('client.product-detail')}}">a Half Very Simple Things You To</a>
                            </h3>
                        </div>
                        <div class="product-card--body">
                            <div class="card-image">
                                ...
                                <div class="hover-contents">
                                    ...
                                    <div class="hover-btns">
                                        <a href="{{route('client.product-detail')}}" class="single-btn">
                                            <i class="fas fa-shopping-basket"></i>
                                        </a>
                                        <a href="{{route('client.wishList')}}" class="single-btn">
                                            <i class="fas fa-heart"></i>
